...
Numérico
mm
Chuva acumulada nas últimas 72 horas
0 – 120
tipo_solo
Categórico
-
Tipo de solo (argiloso, arenoso, franco, misto)
-
umidade_solo
Numérico
%
...
Numérico
m
Distância até corpo d’água mais próximo
1 – 300
peso_equipamento
Numérico
kg
Peso da máquina agrícola
5000 – 15000
tipo_pneu
Categórico
-
Tipo de pneu (esteira, padrao, alta_flutuacao)
-
hora_operacao
Numérico
hora
Hora do dia da operação
0 – 23
historico_atolamentos
Numérico
contagem
...
10 – 40
ocorrencia_atolamento
Binário
-
0 = não atolou / 1 = atolou
-
...
Temperatura influencia indiretamente a umidade do solo, podendo reduzir ou manter a umidade dependendo das condições climáticas
A variável ocorrencia_atolamento representa o resultado final, sendo utilizada como variável alvo para modelos de classificação.

4.6 - Exemplos de Cenários de Risco
Com base nas relações definidas no dataset, alguns cenários apresentam maior probabilidade de atolamento:
Se chuva_72h > 70 mm e umidade_solo > 70% → alto risco
Se tipo_solo = argiloso e umidade_solo elevada → maior retenção de água
Se distancia_agua < 50 m → maior chance de solo saturado
Se declividade > 5% → maior instabilidade do terreno
Se peso_equipamento > 12000 kg em solo úmido → maior pressão e risco
Essas condições não são regras fixas, mas indicam padrões que aumentam a probabilidade de ocorrência de atolamento.
...
Dataset disponível em: data/dataset_exemplo.csv

5. Arquitetura da Solução
fluxo simples do sistema (precisa da arquitetura pronta)
Diagrama disponível em: docs/arquitetura.png
...
Conclusão
O AgroRisk AI propõe uma abordagem inovadora para o setor agrícola, utilizando dados e Inteligência Artificial para prever riscos e melhorar a tomada de decisão.
